...
<div class="card" style="width: 18rem">
    <div class="card-body">
        ...
        <h5 class="card-text"><i class="icon fa-solid fa-people-roof"></i>Manager</h5>
    </div>
...
<div class="card" style="width:18rem;">
    ...
    <div class="card-body">
        <a href="mailto:${engineer.email}">Email ${engineer.name}</a>
...
<div class="card" style="width: 18rem;">
    ...
    <ul class="list-group list-group-flush">
        ...
        <li class="list-group-item cap">School: ${intern.school}</li>
    </ul>
    <div class="card-body">
...
const generateTeam = (data) => {
    ...
    const renderHTML = generateHTML(managerCard, employeeCards);
